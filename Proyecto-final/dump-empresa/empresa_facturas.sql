...
CREATE TABLE `facturas` (
  `numero` varchar(5) COLLATE utf8mb4_es_0900_ai_ci NOT NULL,
  ...
  CONSTRAINT `facturas_ibfk_1` FOREIGN KEY (`dni`) REFERENCES `clientes` (`dni`),
  CONSTRAINT `facturas_ibfk_2` FOREIGN KEY (`matricula`) REFERENCES `vendedores` (`matricula`)
...
-- Dump completed on 2024-08-24 21:55:29
